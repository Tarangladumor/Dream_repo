...
const ProductImages = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="bg-white py-10 rounded-3xl">
      ...
      <div className="max-w-[90%] mx-auto">
        ...
        <div className=" mt-10">
          <Upload
            ...
            setValue={setValue}
            errors={errors}
            editData={product?.invoiceImage} />
        </div>

        <div className="flex gap-x-5 mt-10 justify-between">

          <button className={`flex cursor-pointer items-center gap-x-2 rounded-md bg-[#174B3A] py-[8px] px-[20px] font-semibold text-[white]`}>
