...
<p className="text-[1rem] font-medium font-roboto ">Product Images<sup className="text-[#EF476F]">*</sup></p>
...
<p className='p-4 mt-2  text-sm'> <sup className="text-[#EF476F] text-[15px]">*</sup> Atleast 3 required</p>
...
<p className="text-[1rem] font-medium font-roboto ">Invoice Image<sup className="text-[#EF476F]">*</sup></p>
...
<p className="text-[1rem] mt-6 font-medium font-roboto ">Uploaded Image</p> 
