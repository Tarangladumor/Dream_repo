    ...
    <div className="w-[100vw] h-[100vh] flex justify-center items-center">
      <div className="w-[60%]  shadow-2xl  flex flex-col rounded-3xl justify-center items-center ">
        ...
        {!emailSent && (<div className="">
            <button className=" bg-[#f19a3e] m-auto p-4 rounded-3xl tracking-widest w-[100%] transition-all duration-200 hover:scale-105 text-white flex justify-center text-xl mb-6 mt-4">
              Reset password
            </button>
          </div>)}
        </form>
