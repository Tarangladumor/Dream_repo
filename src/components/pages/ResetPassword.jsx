        ...
        <div className='w-[100vw] h-[100vh] flex justify-center items-center'>
            ...
            <div className='w-[80%]  shadow-2xl m-3 flex flex-col rounded-3xl justify-center items-center '>
                ...
                <div className='w-[28%] text-center text-section-rgba font-roboto mt-1 font-medium'>
                    <p>Have no fear. We’ll email the instructions
                        to reset your password. </p>
                </div>
                <div className='w-[30%]'>
                    <label for="email" class="block mb-2 mt-3 font-medium text-gray-900 text-xl text-loginitem font-roboto">Email</label>
                    <div className='relative'>
                        <input className=' bg-loginfieldbg transition-all duration-200 hover:scale-105 font-roboto' type="email" name="email" id="" placeholder='Enter your registered mail' />
                ...
                <div className=''>
                    <button className=' bg-register-rgba m-auto p-4 px-10 rounded-3xl tracking-widest w-[100%] transition-all duration-200 hover:scale-105 text-white flex justify-center text-xl mb-6 mt-4 font-semibold font-roboto'>Reset password</button>
                </div>
            </div>
        </div>
